 ...
 * @author mantaps
 */
public class data_kerusakan extends javax.swing.JPanel {

    /**
     * Creates new form data_kerusakan
     */
    public data_kerusakan() {
        initComponents();
        Iterable<CSVRecord> records = import_data();
        char karakters[] = {'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'};
        String karakter[] = {"a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"};
        ...
        for(CSVRecord record : records){
            ...
            namagejala[indeks][1] = record.get("kerusakan");
             
            for(int j=0;j<karakter.length;j++){
                if(namagejala[indeks][1].contains(karakter[j])){
                    namagejala[indeks][0] = namagejala[indeks][0];
                    namagejala[indeks][1] = namagejala[indeks][1];
